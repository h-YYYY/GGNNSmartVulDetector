...
import json
import numpy as np
from timestamp.vec2onehot_tmp import vec2onehot
...
dict_NodeName = {"NULL": 0, "S": 1, "W0": 2, "W1": 3, "W2": 4, "W3": 5, "W4": 6, "C0": 7, "C1": 8, "C2": 9,
                 "C3": 10, "C4": 11, "F": 12, "VAR0": 12, "VAR1": 13, "VAR2": 14, "VAR3": 15, "VAR4": 16, "VAR5": 17, }

dict_VarOpName = {"NULL": 0, "BOOL": 1, "ASSIGN": 2, "DANGER": 3}
...
node_convert = {"S": 0, "W0": 1, "C0": 2, "W1": 3, "C1": 4, "W2": 5, "C2": 6, "W3": 7, "C3": 8, "W4": 9, "C4": 10, "F": 11,
                "VAR0": 12, "VAR1": 13, "VAR2": 14, "VAR3": 15, "VAR4": 16, "VAR5": 17}
...
def embedding_node(node_attribute_list):
    ...
    for j in range(0, len(node_attribute_list)):
        ...
        if v in main_point:
            ...
            nodeEmbedding = vfm1.tolist() + vfm2.tolist() + vfm3.tolist()
...
if __name__ == "__main__":
    node = "../../tmp/node/20888.sol"
    edge = "../../tmp/edge/20888.sol"
    ...
    # v_path = "../../data/reentrancy/graph_data/nodes_12/"
    # e_path = "../../data/reentrancy/graph_data/edges_12/"
    #
    ...
    # contract_name = open("./reentrancy_contract_name_12.txt")  # contracts list
    # contract_label = open("./reentrancy_contract_label_12.txt")  # contracts label
