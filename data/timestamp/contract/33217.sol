...
contract BlockchainDeposit {
  ...
  string[] Currencies = ["DBC", "ETH", "BTC"];  
  uint[] Term = [3,7,14,21,30,90,180,365];  
  ...
  function BlockchainDeposit() {
    ...
    feesRateTeam = 20;  
    feesRateCongres = 30;  
    feesProfitDeposit = 1000;  
    garanteSystemDepositInOneFund = 100000000000;  
    garanteSystemDepositInAllFunds = 500000000000;  
    numDeposits = 0;
