...
contract ManageableContract is Ownable {
    ...
    mapping (address => bool) internal pf_manager;  
    uint256[] internal pf_m_count;  

    mapping (address => bool) internal performers;
    uint256[] internal pf_count;  

    mapping (address => bool) internal cr_manager;  
    uint256[] internal cr_count;  

    mapping (address => bool) internal clients;
    uint256[] internal cli_count;  
